...
from flask import current_app, jsonify, request # Added request
...
def get_user_details(user_id, token):
    ...
    try:
        # Assuming user-service has an endpoint like /users/<id> or uses /me
        # Using /me as it's already implemented in user-service
